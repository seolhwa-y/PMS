...
SELECT  MOU_PROCODE AS PROCODE,
                ...
                MET_MCCODE AS MCCODE,
                MCA_NAME AS MCNAME
FROM MOU        INNER JOIN MET ON MOU_PROCODE = MET_MJPROCODE AND MOU_CODE = met.met_mjmoucode AND jos.jos_code = met.met_mjjoscode
                INNER JOIN MCA ON MET_MCCODE = MCA_CODE 
                INNER JOIN MJ ON MOU_PROCODE = MJ_PROCODE AND MOU_CODE = mj.mj_moucode
...
--SYNONYM
CREATE SYNONYM FIL FOR TEAM4.RESULTFILES;
