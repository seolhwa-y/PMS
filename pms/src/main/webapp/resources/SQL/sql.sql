...
INSERT INTO MOU(MOU_PROCODE, MOU_CODE, MOU_NAME, MOU_COMMENTS) VALUES('22080110153420220702', '10', 'CERTIFICATION', '로그인,로그아웃,회원가입');
INSERT INTO MOU(MOU_PROCODE, MOU_CODE, MOU_NAME, MOU_COMMENTS) VALUES('22080110153420220702', '30', 'DASHBOARD', '초대정보,내가참여한 프로젝트 정보');
INSERT INTO MOU(MOU_PROCODE, MOU_CODE, MOU_NAME, MOU_COMMENTS) VALUES('22080110153420220702', '40', 'MY', '?');
INSERT INTO MOU(MOU_PROCODE, MOU_CODE, MOU_NAME, MOU_COMMENTS) VALUES('22080110153420220702', '50', 'NOTICE', '?');
INSERT INTO MOU(MOU_PROCODE, MOU_CODE, MOU_NAME, MOU_COMMENTS) VALUES('22080110153420220702', '20', 'PROJECT', '프로젝트 생성, 멤버 초대');
INSERT INTO MOU(MOU_PROCODE, MOU_CODE, MOU_NAME, MOU_COMMENTS) VALUES('22080110153420220702', '60', 'SETTING', '?');
/* JOB(JOB) 
  PK FK 프로젝트코드
  PK    업무코드
     NN 업무명
...
-- DATA
INSERT INTO JOS(JOS_PROCODE, JOS_CODE, JOS_NAME, JOS_COMMENTS) VALUES('22080110153420220702','101','FIRST','세션 O -> 대쉬보드페이지, 세션 X -> 로그인페이지');
...
SELECT*FROM MJ;
-- DATA
INSERT INTO MJ(MJ_PROCODE, MJ_MOUCODE, MJ_JOSCODE, MJ_PRMPMBCODE) VALUES('22080110153420220702','20','202','20220701');
INSERT INTO MJ(MJ_PROCODE, MJ_MOUCODE, MJ_JOSCODE, MJ_PRMPMBCODE) VALUES('22080110153420220702','10','101','20220701');
INSERT INTO MJ(MJ_PROCODE, MJ_MOUCODE, MJ_JOSCODE, MJ_PRMPMBCODE) VALUES('22080110153420220702','10','102','20220701');
INSERT INTO MJ(MJ_PROCODE, MJ_MOUCODE, MJ_JOSCODE, MJ_PRMPMBCODE) VALUES('22080110153420220702','10','103','20220701');
INSERT INTO MJ(MJ_PROCODE, MJ_MOUCODE, MJ_JOSCODE, MJ_PRMPMBCODE) VALUES('22080110153420220702','10','104','20220701');
INSERT INTO MJ(MJ_PROCODE, MJ_MOUCODE, MJ_JOSCODE, MJ_PRMPMBCODE) VALUES('22080110153420220702','10','105','20220701');
INSERT INTO MJ(MJ_PROCODE, MJ_MOUCODE, MJ_JOSCODE, MJ_PRMPMBCODE) VALUES('22080110153420220702','20','201','20220701');
INSERT INTO MJ(MJ_PROCODE, MJ_MOUCODE, MJ_JOSCODE, MJ_PRMPMBCODE) VALUES('22080110153420220702','20','203','20220701');
INSERT INTO MJ(MJ_PROCODE, MJ_MOUCODE, MJ_JOSCODE, MJ_PRMPMBCODE) VALUES('22080110153420220702','30','301','20220701');
INSERT INTO MJ(MJ_PROCODE, MJ_MOUCODE, MJ_JOSCODE, MJ_PRMPMBCODE) VALUES('22080110153420220702','30','302','20220701');
...
WHERE MET_MJPROCODE = '22080110153420220702';
		...
		FROM MOU INNER JOIN JOS ON MOU_PROCODE = JOS_PROCODE
                 INNER JOIN MJ ON MOU_PROCODE = MJ_PROCODE
                 INNER JOIN MET ON MOU_PROCODE = MET_MJPROCODE;
                 
        GRANT SELECT,INSERT,UPDATE ON TEAM4.PROCESSINFO TO SHY, CJS, CHAE; 
        CREATE SYNONYM PROCESSINFO FOR TEAM4.PROCESSINFO;
        
		SELECT *
        FROM PROCESSINFO
        WHERE PROCESSINFO.PROCODE = '22080110153420220702';
        
        		SELECT 	MET_MJPROCODE AS PROCODE,
				MET_MJMOUCODE AS MOUCODE, 
				SMET_MJJOSCODE AS JOSCODE, 
				MET_CODE AS METCODE, 
				MET_NAME AS METNAME, 
				MET_MCCODE AS MCCODE,
				MCA_NAME AS MCNAME
